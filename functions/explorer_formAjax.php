    ...
    echo "<tr>";
        ...
        if ( $fileInfo->isDir()){   // c'est un dossier
            ...
            <a href='?directory=$directory/$fileName'>" . $fileName . "</a>
                 <button type='texte' name='directory' class='navigation' data-directory='$directory/$fileName'> $directory/$fileName </button>
